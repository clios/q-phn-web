...
function FamilyUpdate() {
  ...
  React.useEffect(() => {
    ...
    if (F.data) {
      setStatus('success')
      setRecordedAt(FormUtils.dateOrEmpty(F.data.recorded_at))
      setNameOfHead(FormUtils.valOrEmpty(F.data.name_of_head))
      setTotalMembers(FormUtils.valOrEmpty(F.data.total_members))
      setTotalChildren(FormUtils.valOrEmpty(F.data.total_children))
      setAddressMunicipal(FormUtils.valOrEmpty(F.data.address_municipal))
      setAddressBarangay(FormUtils.valOrEmpty(F.data.address_barangay))
      setAddressPurok(FormUtils.valOrEmpty(F.data.address_purok))
      setAddressStreet(FormUtils.valOrEmpty(F.data.address_street))
      ...
      setPills(FormUtils.onArrayOrFalse(F.data.planning_methods, 'pills'))
      setCondom(FormUtils.onArrayOrFalse(F.data.planning_methods, 'condom'))
      setIntrauterineDevice(FormUtils.onArrayOrFalse(F.data.planning_methods, 'intrauterine device'))
      setDmpaInjection(FormUtils.onArrayOrFalse(F.data.planning_methods, 'dmpa injection'))
      setVasectomy(FormUtils.onArrayOrFalse(F.data.planning_methods, 'vasectomy'))
      setTubalLigation(FormUtils.onArrayOrFalse(F.data.planning_methods, 'tubal ligation'))
      setBasalBodyTemperature(FormUtils.onArrayOrFalse(F.data.planning_methods, 'basal body temperature'))
      setCervicalMucus(FormUtils.onArrayOrFalse(F.data.planning_methods, 'cervical mucus'))
      setSymptoThermal(FormUtils.onArrayOrFalse(F.data.planning_methods, 'sympto-thermal'))
      setLactationAmenorrhea(FormUtils.onArrayOrFalse(F.data.planning_methods, 'lactation amenorrhea'))
      setStandardDays(FormUtils.onArrayOrFalse(F.data.planning_methods, 'standard days'))
      setTwoDay(FormUtils.onArrayOrFalse(F.data.planning_methods, 'two-day'))
      setOwned(FormUtils.onArrayOrFalse(F.data.house_units, 'owned'))
      setRented(FormUtils.onArrayOrFalse(F.data.house_units, 'rented'))
      setCaretaken(FormUtils.onArrayOrFalse(F.data.house_units, 'caretaken'))
      setConcrete(FormUtils.onArrayOrFalse(F.data.house_units, 'concrete'))
      setWooden(FormUtils.onArrayOrFalse(F.data.house_units, 'wooden'))
      setMakeshift(FormUtils.onArrayOrFalse(F.data.house_units, 'makeshift'))
      setSingle(FormUtils.onArrayOrFalse(F.data.house_units, 'single'))
      setDuplex(FormUtils.onArrayOrFalse(F.data.house_units, 'duplex'))
      setCommercial(FormUtils.onArrayOrFalse(F.data.house_units, 'commercial'))
      setApartment(FormUtils.onArrayOrFalse(F.data.house_units, 'apartment'))
      setImprovised(FormUtils.onArrayOrFalse(F.data.house_units, 'improvised'))
      setElectricity(FormUtils.onArrayOrFalse(F.data.house_lights, 'electricity'))
      setGasLamp(FormUtils.onArrayOrFalse(F.data.house_lights, 'gas lamp'))
      setTap(FormUtils.onArrayOrFalse(F.data.water_supplies, 'tap'))
      setSpring(FormUtils.onArrayOrFalse(F.data.water_supplies, 'spring'))
      setDugWell(FormUtils.onArrayOrFalse(F.data.water_supplies, 'dug well'))
      setPublicWell(FormUtils.onArrayOrFalse(F.data.water_supplies, 'public well'))
      setPublicFaucet(FormUtils.onArrayOrFalse(F.data.water_supplies, 'public faucet'))
      setWaterSealedExclusive(FormUtils.onArrayOrFalse(F.data.toilets, 'water-sealed exclusive'))
      setWaterSealedShared(FormUtils.onArrayOrFalse(F.data.toilets, 'water-sealed shared'))
      setClosedPit(FormUtils.onArrayOrFalse(F.data.toilets, 'closed pit'))
      setOpenedPit(FormUtils.onArrayOrFalse(F.data.toilets, 'opened pit'))
      setCollecting(FormUtils.onArrayOrFalse(F.data.garbage_disposals, 'collecting'))
      setSegregating(FormUtils.onArrayOrFalse(F.data.garbage_disposals, 'segregating'))
      setComposting(FormUtils.onArrayOrFalse(F.data.garbage_disposals, 'composting'))
      setBurning(FormUtils.onArrayOrFalse(F.data.garbage_disposals, 'burning'))
      setBurying(FormUtils.onArrayOrFalse(F.data.garbage_disposals, 'burying'))
      setRadio(FormUtils.onArrayOrFalse(F.data.communication_facilities, 'radio'))
      setTwoWayRadio(FormUtils.onArrayOrFalse(F.data.communication_facilities, 'two-way radio'))
      setCableTelevision(FormUtils.onArrayOrFalse(F.data.communication_facilities, 'cable television'))
      setAntennaTelevision(FormUtils.onArrayOrFalse(F.data.communication_facilities, 'antenna television'))
      setMobilePhone(FormUtils.onArrayOrFalse(F.data.communication_facilities, 'mobile phone'))
      setLandlinePhone(FormUtils.onArrayOrFalse(F.data.communication_facilities, 'landline phone'))
      setBicycle(FormUtils.onArrayOrFalse(F.data.transportation_facilities, 'bicycle'))
      setMotorcycle(FormUtils.onArrayOrFalse(F.data.transportation_facilities, 'motorcycle'))
      setTricycle(FormUtils.onArrayOrFalse(F.data.transportation_facilities, 'tricycle'))
      setKuliglig(FormUtils.onArrayOrFalse(F.data.transportation_facilities, 'kuliglig'))
      setJeepney(FormUtils.onArrayOrFalse(F.data.transportation_facilities, 'jeepney'))
      setCar(FormUtils.onArrayOrFalse(F.data.transportation_facilities, 'car'))
      setTruck(FormUtils.onArrayOrFalse(F.data.transportation_facilities, 'truck'))
      setVan(FormUtils.onArrayOrFalse(F.data.transportation_facilities, 'van'))
      setRice(FormUtils.onArrayOrFalse(F.data.agricultural_products, 'rice'))
      setCorn(FormUtils.onArrayOrFalse(F.data.agricultural_products, 'corn'))
      setBanana(FormUtils.onArrayOrFalse(F.data.agricultural_products, 'banana'))
      setTaro(FormUtils.onArrayOrFalse(F.data.agricultural_products, 'taro'))
      setCassava(FormUtils.onArrayOrFalse(F.data.agricultural_products, 'cassava'))
      setPoultryChicken(FormUtils.valOrEmpty(F.data.poultry_chicken))
      setPoultryDuck(FormUtils.valOrEmpty(F.data.poultry_duck))
      setPoultryGeese(FormUtils.valOrEmpty(F.data.poultry_geese))
      setPoultryTurkey(FormUtils.valOrEmpty(F.data.poultry_turkey))
      setLivestockPig(FormUtils.valOrEmpty(F.data.livestock_pig))
      setLivestockGoat(FormUtils.valOrEmpty(F.data.livestock_goat))
      setLivestockSheep(FormUtils.valOrEmpty(F.data.livestock_sheep))
      setLivestockCow(FormUtils.valOrEmpty(F.data.livestock_cow))
      setLivestockCarabao(FormUtils.valOrEmpty(F.data.livestock_carabao))
      setLivestockHorse(FormUtils.valOrEmpty(F.data.livestock_horse))
      setSariSariStore(FormUtils.onArrayOrFalse(F.data.other_livelihoods, 'sari-sari store'))
      setRestaurant(FormUtils.onArrayOrFalse(F.data.other_livelihoods, 'restaurant'))
      setBakeshop(FormUtils.onArrayOrFalse(F.data.other_livelihoods, 'bakeshop'))
      setFishpondArea(FormUtils.valOrEmpty(F.data.fishpond_area))
      setOwnedRiceFieldArea(FormUtils.valOrEmpty(F.data.owned_rice_field_area))
      setOwnedCornFieldArea(FormUtils.valOrEmpty(F.data.owned_corn_field_area))
      setLease(FormUtils.onArrayOrFalse(F.data.unowned_lands, 'lease'))
      setTenant(FormUtils.onArrayOrFalse(F.data.unowned_lands, 'tenant'))
      setCaretaker(FormUtils.onArrayOrFalse(F.data.unowned_lands, 'caretaker'))
      setUnownedRiceFieldArea(FormUtils.valOrEmpty(F.data.unowned_rice_field_area))
      setUnownedCornFieldArea(FormUtils.valOrEmpty(F.data.unowned_corn_field_area))
      setMonthlyAverageIncome(FormUtils.valOrEmpty(F.data.monthly_average_income))
    }
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.status === 201) {
          toast.success('Family updated successfully') // SUCCESSFUL OPERATION
          navigate('/families/' + ROUTE.family_id, { replace: true })
        }
      })
      .catch((error) => {
        setStatus('success')
  ...
  return (
    <Authorization permissions={ACCOUNT.permissions} permission="write_family">
      <Form status={status}>
        <PageTitle
          title="Edit Family"
          description="Modify family record. For unknown answers, please leave it blank. For date visited, January to June will be considered as first visit and July to December as second visit."
        />
