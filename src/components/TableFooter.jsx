    ...
    <div className="table-footer bg-dark">
      <div className="select">
        <select onChange={selectItemsPerPage} value={items_per_page}>
          <option value={2}>Items per page: 2</option>
      ...
      <div className="table-footer-desc">
        ...
        {items_per_page * current_page > props.total ? props.total : items_per_page * current_page} of{' '}
        {props.total?.toLocaleString()} items
      </div>
      <div className="select">
      ...
      <button className="button is-gray is-icon" disabled={current_page === 1} onClick={prevPage}>
        <ChevronLeft20 />
      </button>
      <button className="button is-gray is-icon" disabled={current_page === total_pages} onClick={nextPage}>
        <ChevronRight20 />
      </button>
    </div>
  )
